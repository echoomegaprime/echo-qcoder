...
## QCoder repository boundary

Follow `AGENTS.md`. Keep the launcher as a thin adapter over the governed SOL launcher, and keep the ChatGPT control plane limited to typed QCoder session operations rather than arbitrary command execution.
